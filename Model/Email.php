...
namespace Pbyteshub\Smtp\Model;
...
use Pbyteshub\Smtp\Helper\Data;

class Email
{
    const XML_PATH_EMAIL_TEMPLATE_ZEND_TEST  = 'system/Smtp/zend_email_template';

    const XML_PATH_EMAIL_TEMPLATE_MAGENTO_TEST  = 'system/Smtp/magento_email_template';
